...
class FlutterMidiCommandPlusPlugin : FlutterPlugin, ActivityAware, MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
...
//              SCAN_FAILED_SCANNING_TOO_FREQUENTLY to "Scanning too frequently"
    ...
    private val deviceOpenedListener = object : MidiManager.OnDeviceOpenedListener {
        override fun onDeviceOpened(it: MidiDevice?) {
            ...
            it?.also {
                val device = ConnectedDevice(it, this@FlutterMidiCommandPlusPlugin.setupStreamHandler)
                var result = this@FlutterMidiCommandPlusPlugin.ongoingConnections[device.id]
    ...
    private val deviceConnectionCallback = object : MidiManager.DeviceCallback() {
        ...
        override fun onDeviceAdded(device: MidiDeviceInfo?) {
            ...
            device?.also {
                ...
                this@FlutterMidiCommandPlusPlugin.setupStreamHandler.send("deviceFound")
            }
        }
